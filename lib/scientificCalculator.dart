...
class _ScientificCalculatorState extends State<ScientificCalculator> {
  ...
  String expression = '';
  double equationFontSize = 80.0; // Increased font size
  double resultFontSize = 60.0; // Increased font size
  ...
  void _clear() {
    ...
    result = '';
    expression = '';
    equationFontSize = 80.0; // Reset to larger font size
    resultFontSize = 60.0; // Reset to larger font size
  }

  void _simpleOperands(value) {
    setState(() {
      equationFontSize = 80.0; // Increased font size
      resultFontSize = 60.0; // Increased font size
      switch (value) {
        case MODULAR_SIGN:
          if (result != '') {
  ...
  void _simpleResult() {
    setState(() {
      equationFontSize = 60.0; // Reset font size
      resultFontSize = 40.0; // Reset font size
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              // color: Color(0xFF87CEEB), // Remove background color
